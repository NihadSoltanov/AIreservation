...
export default function SettingsPage() {
  ...
  const [website, setWebsite] = useState("https://autoreserv.demo")
        ...
        <div className="flex-1 min-w-0">
          ...
          {activeSection === "channels" && (
            <Card>
              ...
              <CardContent className="space-y-4">
                {[
                  { name: "WhatsApp", status: "connected", desc: "Connected via Facebook Business API" },
          ...
          {activeSection === "team" && (
            <Card>
              ...
              <CardContent className="space-y-3">
                {[
                  { name: "Ahmad Khalid", email: "ahmad@demo.com", role: "Owner" },
                  { name: "Sara Ali", email: "sara@demo.com", role: "Admin" },
                  { name: "Mike Chen", email: "mike@demo.com", role: "Agent" },
                ].map(m => (
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-[var(--muted)]">Last changed 30 days ago</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-[var(--foreground)]">API Keys</p>
                    <p className="text-xs text-[var(--muted)]">Manage developer access keys</p>
                  </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                {[
                  ...
                  { name: "Google Sheets", desc: "Sync leads to spreadsheets", connected: true },
                  ...
                  <div key={int.name} className="flex items-center justify-between py-2">
                    ...
                    <Button
                      size="sm"
                      variant={int.connected ? "outline" : "ghost"}
                      style={int.connected ? {} : { color: ac }}
                    >
